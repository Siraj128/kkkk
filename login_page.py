...
try:
    ...
    st.error("Please configure Google OAuth credentials in secrets.toml")
    st.stop()
...
def show_leaderboard():
    """Beautiful animated leaderboard"""
    ...
    current_user_name = st.session_state.user_record['name'] if st.session_state.user_record else "Anonymous"
    ...
    leaderboard_data = [
        ...
        {
            "rank": 3, "name": current_user_name, "score": 2650, "games": 15, 
    ...
    for player in leaderboard_data:
        is_you = player['name'] == current_user_name
...
# --- PROFILE SETUP PAGE ---
    ...
    with col2:
        ...
        st.write("Choose a username that will appear on leaderboards.")
...
# --- AUTHENTICATED MAIN APP ---
    ...
    if st.session_state.current_page == "quiz":
        ...
        with st.sidebar:
            ...
            st.markdown("**📊 Status:** 🟢 Online & Authenticated")
            st.markdown("---")
        ...
        <div style="text-align: center; margin-bottom: 40px;">
            ...
            <p style="font-size: 1.3rem; opacity: 0.8;">
                Ready for an amazing quiz experience with real authentication!
            </p>
        </div>
        """, unsafe_allow_html=True)
        ...
        with col1:
            ...
            <div class="dashboard-card">
                ...
                <p style="text-align: center;">Authenticated Player</p>
        ...
        st.success("✅ Google OAuth: **AUTHENTICATED**")
